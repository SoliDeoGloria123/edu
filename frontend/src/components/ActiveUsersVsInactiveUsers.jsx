...
export default function ActiveUsersVsInactiveUsers() {
    ...
    // Datos de la API
    const { data: activeUsersApi, loading: activeUsersApiLoading } =
        useGetApi("users/stats/active");
    const { data: inactiveUsersApi, loading: inactiveUsersApiLoading } =
