    ...
    return (
        <div className="flex flex-col h-screen max-h-[100vh] bg-base-100 p-6 space-y-10">
            <div className="flex w-full justify-center ">
                <h1 className="text-2xl lg:text-6xl font-extrabold">ESTADISTICAS PRINCIPALES</h1>
            </div>
                        ...
                        <div className="stats stats-vertical bg-base-100 border-base-300 p-4 w-full">
                            ...
                            <div className="stat">
                                ...
                                <div className="stat-desc">
                                    ↗︎ {((activeCount / totalUsers) * 100).toFixed(1)}% del total
                                </div>
                            </div>

                            <div className="stat">
                                <div className="stat-title">Usuarios inactivos</div>
                                <div className="stat-value text-error">{inactiveCount}</div>
                                <div className="stat-desc">
                                    ↘︎ {inactivityPercentage}% del total
                                </div>
                            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
                        ...
                        <div className="stats stats-vertical shadow w-full">
                            ...
                            <div className="stat">
                                ...
                                <div className="stat-desc">
                                    Usuarios que permanecen activos
                                </div>
                            </div>
